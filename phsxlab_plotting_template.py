# -*- coding: utf-8 -*-
"""PHSXlab_plotting_template.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/github/brianna-phsx/plotting-templates/blob/main/PHSXlab_plotting_template.ipynb
"""
...
xvariable_changeme = np.array([.9, 2.6, 4.3, 6.4, 8.2, 10])

yvariable_changeme = np.array([2448.04, 3425.1, 4410, 5392.94, 6370.98, 7355.88])

err_yvariable_changeme = np.array([68.6, 68.6, 68.6, 78.4, 78.4,88.2])
...
plot_title= 'F=mg vs. Displacement of Steel Spring'
x_label= 'Displacement (CM)'
y_label= 'F (N)'
slope_units= 'F/CM'
